...
class __TwigTemplate_6da84254fa401dedbfd9801896fe7fbba6f69e058aff58ff077dc70d0acf3941 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "C:\\OpenServer\\domains\\drupal\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
